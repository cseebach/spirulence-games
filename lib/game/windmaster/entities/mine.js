...
(function() {
  ...
  ig.module("game.windmaster.entities.mine").requires('impact.game', 'impact.animation', 'game.windmaster.entities.placeable', 'game.windmaster.techs').defines(function() {
    return window.Mine = Placeable.extend({
      size: {
        x: 16,
        y: 16
      },
